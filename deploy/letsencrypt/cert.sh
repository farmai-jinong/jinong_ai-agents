...
# 선행: ① DNS A 레코드(jinong-stt-report-generation.jinongservice.co.kr → 13.125.70.226) ② 호스트 nginx vhost 가
...
DOMAIN_NAME=jinong-stt-report-generation.jinongservice.co.kr
